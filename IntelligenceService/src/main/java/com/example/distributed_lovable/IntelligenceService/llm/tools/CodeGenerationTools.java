package com.example.distributed_lovable.IntelligenceService.llm.tools;
...
public class CodeGenerationTools
{
    ...
    public List<String> readFiles(
        ...
        for(String path:paths)
        {
            ...
            String content = workspaceClient.getFileContent("Bearer " + jwt,projectId,cleanPath).content();
